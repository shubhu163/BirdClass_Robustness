...
adversarial_dir = "/nfs/hpc/share/joshishu/DL_Project/PGD_Images_n=15/Adv_Images"
combined_dir = "/nfs/hpc/share/joshishu/DL_Project/PGD_Images_n=15/Combined_adv_orig"
...
# Define the attack
epsilon = 16/255  # Perturbation level
# attack = torchattacks.FGSM(model, eps=epsilon)
#attack = torchattacks.BIM(model, eps=epsilon, alpha=1/255, steps=4)
attack = torchattacks.PGD(model, eps=epsilon, alpha=4/255, steps=14)
